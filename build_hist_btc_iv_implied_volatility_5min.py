...
## NOTES: the IV index is the standard deviation the underlying asset's returns.

## NOTES:
## The 'datetime' fields from 'btc_iv_implied_volatility_5min' collection are 
...
collection = db['btc_iv_implied_volatility_5min']
...
if last_document is None:
    ...
    i_date = last_document['datetime'] + datetime.timedelta(minutes=5)
...
while i_date <= f_date:
    ...
    f_ts_unix = i_ts_unix + 299000 #  + 4min59sec 
